...
ET::$languageInfo["Dutch"] = array(
	"locale" => "nl-NL",
	"name" => "Dutch",
	"description" => "Dutch translated pack",
	"version" => ESOTALK_VERSION,
	"author" => "tkon99",
	"authorEmail" => "no-reply@dutchcodegeeks.tk",
	"authorURL" => "http://dutchcodegeeks.tk",
	"license" => "GPLv2"
);
...
$definitions["%s can view this conversation."] = "%s kan deze conversatie weergeven.";
$definitions["%s changed %s's group to %s."] = "%s veranderde %s's groep naar %s.";
$definitions["%s changed your group to %s."] = "%s veranderde jouw groep naar %s.";
$definitions["%s conversation"] = "%s conversatie";
$definitions["%s conversations"] = "%s conversaties";
$definitions["%s invited you to %s."] = "%s heeft jou uitgenodigd op %s.";
$definitions["%s joined the forum."] = "%s is nu lid van het forum.";
$definitions["%s post"] = "%s bericht";
$definitions["%s posted %s"] = "%s heeft %s gepost.";
$definitions["%s posted in %s."] = "%s heeft in %s gepost.";
$definitions["%s posts"] = "%s posts";
$definitions["%s reply"] = "%s antwoord";
$definitions["%s replies"] = "%s antwoorden";
$definitions["%s Settings"] = "%s Instellingen";
$definitions["%s started the conversation %s."] = "%s heeft de conversatie gestart %s.";
$definitions["%s tagged you in a post."] = "%s heeft je genoemd in een bericht.";
$definitions["%s will be able to view this conversation."] = "%s zal deze conversatie kunnen zien.";
$definitions["%s will be able to:"] = "%s zal kunnen:";
...
$definitions["a private conversation"] = "een persoonlijk gesprek";
$definitions["Access the administrator control panel."] = "Toegang tot het administratie paneel.";
$definitions["Account type"] = "Account type";
$definitions["Activate"] = "Activeer";
$definitions["Activity"] = "Activiteit";
$definitions["Add"] = "Toevoegen";
$definitions["Administration"] = "Administratie";
$definitions["Administrator email"] = "Eigenaar email";
$definitions["Administrator password"] = "Eigenaar wachtwoord";
$definitions["Administrator username"] = "Eigenaar gebruikersnaam";
$definitions["Advanced options"] = "Geavenceerde instellingen";
$definitions["All Channels"] = "Alle kanalen";
$definitions["Allow members to edit their own posts:"] = "Leden toestaan hun eigen berichten te bewerken:";
$definitions["Already have an account? <a href='%s' class='link-login'>Log in!</a>"] = "Heb je al een account? <a href='%s' class='link-login'>Log in!</a>";
$definitions["Appearance"] = "Uiterlijk";
$definitions["Automatically star conversations that I reply to"] = "Volg conversaties waar ik op antwoord automatisch";
$definitions["Avatar"] = "Avatar";

$definitions["Back to channels"] = "Terug naar kanalen";
$definitions["Back to conversation"] = "Terug naar conversatie";
...
$definitions["Background color"] = "Achtergrond kleur";
...
$definitions["Can suspend/unsuspend members"] = "Kan leden schorsen/activeren";
$definitions["Cancel"] = "Annuleren";
$definitions["Change %s's Permissions"] = "Verander %s's permissie";
$definitions["Change avatar"] = "Verander avatar";
$definitions["Change Channel"] = "Verander Kanaal";
$definitions["Change channel"] = "Verander kanaal";
$definitions["Change username"] = "Verander gebruikersnaam";
$definitions["Change Password or Email"] = "Verander wachtwoord of email";
$definitions["Change Password"] = "Verander Wachtwoord";
$definitions["Change password"] = "Verander wachtwoord";
$definitions["Change permissions"] = "Verander toestemming permissies";
$definitions["Change"] = "Verander";
$definitions["Channel description"] = "Kanaal beschrijving";
$definitions["Channel List"] = "Kanaal lijst";
$definitions["Channel title"] = "Kanaal titel";
$definitions["Channel slug"] = "Kanaal slogan";
$definitions["Channels"] = "Kanalen";
$definitions["Choose a secure password of at least %s characters"] = "Kies een veilig wachtwoord van tenminste %s tekens";
$definitions["Choose what people will see when they first visit your forum."] = "Kies wat mensen als eerste zien als ze je forum bezoeken";
$definitions["Click on a member's name to remove them."] = "Klik op een lid zijn naam om hem te verwijderen";
$definitions["Close registration"] = "Sluit registratie";
$definitions["Confirm password"] = "Bevestig wachtwoord";
$definitions["Context"] = "Context";
$definitions["Controls"] = "Controls";
$definitions["Conversation"] = "Conversatie";
$definitions["Conversations participated in"] = "Conversaties waarin gepost";
$definitions["Conversations started"] = "Conversaties gestart";
$definitions["Conversations"] = "Conversaties";
$definitions["Copy permissions from"] = "Kopieer permissies van";
$definitions["Create Channel"] = "Maak Kanaal";
$definitions["Create Group"] = "Maak Groep";
$definitions["Create Member"] = "Maak Lid";
$definitions["Customize how users can become members of your forum."] = "Pas aan hoe gebruikers lid kunnen worden van jouw forum.";
$definitions["Customize your forum's appearance"] = "Pas het uiterlijk van je forum aan.";

$definitions["Dashboard"] = "Dashboard";
$definitions["Default forum language"] = "Standaard forum taal";
$definitions["<strong>Delete</strong> all conversations forever."] = "<strong>Verwijder</strong> alle converstaties voor altijd.";
$definitions["Delete Channel"] = "Verwijder Kanaal";
$definitions["Delete conversation"] = "Verwijder conversatie";
$definitions["Delete member"] = "Verwijder lid";
$definitions["Delete Member"] = "Verwijder Lid";
$definitions["<strong>Delete this member's posts.</strong> All of this member's posts will be marked as deleted, but will be able to be restored manually."] = "<strong>Verwijder dit lid zijn posts.</strong> Alle posts van dit lid zullen als verwijderd worden gemarkeerd maar kunnen handmatig worden teruggezet.";
$definitions["Delete"] = "Verwijder";
$definitions["Deleted %s by %s"] = "%s verwijderd door %s";
$definitions["Disable"] = "Uitschakelen";
$definitions["Discard"] = "Ongedaan maken";
$definitions["Don't have an account? <a href='%s' class='link-join'>Sign up!</a>"] = "Heb je geen account? <a href='%s' class='link-join'>Registreer!</a>";
$definitions["Don't repeat"] = "Niet herhalen";

$definitions["Edit Channel"] = "Kanaal Bewerken";
$definitions["Edit Group"] = "Groep Bewerken";
$definitions["Edit member groups"] = "Groepen voor leden bewerken";
$definitions["Edit your profile"] = "Je profiel bewerken";
$definitions["Edit"] = "Bewerk";
$definitions["Edited %s by %s"] = "%s bewerkt door %s";
$definitions["Editing permissions"] = "Permissies bewerken";
$definitions["Email me when I'm added to a private conversation"] = "Email mij wanneer ik ben toegevoegd aan een persoonlijke conversatie";
$definitions["Email me when someone posts in a conversation I have starred"] = "Email mij wanneer iemand een bericht plaatst in een favoriete conversatie van mij";
$definitions["Email"] = "Email";
$definitions["Enable"] = "Toestaan";
$definitions["Enabled"] = "Toegestaan";
$definitions["Enter a conversation title"] = "Vul een conversatie titel in";
$definitions["Error"] = "Error";
$definitions["esoTalk version"] = "esoTalk versie";
$definitions["Everyone"] = "Iedereen";

$definitions["Fatal Error"] = "Oh oh! Het is een fatale error...";
$definitions["Feed"] = "Feed";
$definitions["Filter by name or group..."] = "Filteren bij naam of groep...";
$definitions["Filter conversations..."] = "Filter conversaties...";
$definitions["Find this post"] = "Vind deze post";
$definitions["First posted"] = "Als eerst geplaatst";
$definitions["Follow to receive notifications"] = "Volg om notificaties te ontvangen";
$definitions["For %s seconds"] = "Voor %s seconden";
$definitions["Forever"] = "Eeuwig";
$definitions["Forgot?"] = "Vergeten?";
$definitions["Forgot Password"] = "Wachtwoord vergeten";
$definitions["Forum header"] = "Forumkop";
$definitions["Forum language"] = "Forumtaal";
$definitions["Forum Settings"] = "Foruminstellingen";
$definitions["Forum Statistics"] = "Forumstatistieken";
$definitions["Forum title"] = "Forumtitel";
$definitions["forumDescription"] = "%s is een web-forum over %s, en %s.";

$definitions["Give this group the 'moderate' permission on all existing channels"] = "Geef deze groep 'middelmatige' toegang op alle bestaande kanalen";
$definitions["Global permissions"] = "Globale permissies";
$definitions["Go to top"] = "Naar de bovenkant";
$definitions["Group name"] = "Groepsnaam";
...
$definitions["group.member"] = "Gebruiker";
$definitions["group.member.plural"] = "Gebruikers";
$definitions["group.Moderator"] = "Moderator";
$definitions["group.Moderator.plural"] = "Moderatoren";
$definitions["group.suspended"] = "Suspended"; //TODO:: THIS IS NOT TRANSLATED
$definitions["Groups can be used to categorize members and give them certain privileges."] = "Groepen kunnen gebruikt worden om gebruikers te categoriseren en om hen bepaalde privileges te geven.";
$definitions["Groups"] = "Groepen";

$definitions["Header"] = "Kop";
$definitions["Header color"] = "Kop kleur";
$definitions["Hide"] = "Verberg";
$definitions["Home page"] = "Thuispagina";
$definitions["HTML is allowed."] = "HTML is toegestaan.";

$definitions["If you run into any other problems or just want some help with the installation, feel free to ask for assistance at the <a href='%s'>esoTalk support forum</a>."] = "Als je problemen tegenkomt of hulp nodig hebt met de installatie, voel je dan vrij om hulp te vragen op het <a href='%s'>esoTalk ondersteuningsforum</a>.";
$definitions["Install esoTalk"] = "esoTalk installeren";
$definitions["Install My Forum"] = "Mijn Forum installeren";
$definitions["Installed Languages"] = "Geïnstalleerde Talen";
$definitions["Installed Plugins"] = "Geïnstalleerde Plugins";
$definitions["Installed plugins"] = "Geïnstalleerde plugins";
$definitions["Installed Skins"] = "Geïnstalleerde Skins";
$definitions["Installed skins"] = "Geïnstalleerde skins";
$definitions["is %s"] = "is %s";

$definitions["Joined"] = "Lid geworden";
$definitions["Jump to last"] = "Spring naar laatste";
$definitions["Jump to unread"] = "Spring naar ongelezen";
$definitions["just now"] = "nu net";

$definitions["Keep me logged in"] = "Zorg dat ik ingelogd blijf";
$definitions["<strong>Keep this member's posts.</strong> All of this member's posts will remain intact, but will show [deleted] as the author."] = "<strong>Bewaar de berichten van deze gebruiker.</strong> Alle berichten van deze gebruiker zullen bewaard blijven, maar er zal [verwijderd] staan als auteur.";

$definitions["label.draft"] = "Concept";
$definitions["label.locked"] = "Op slot";
$definitions["label.muted"] = "Stil";
$definitions["label.private"] = "Privé";
$definitions["label.sticky"] = "Geplakt";
$definitions["Labels"] = "Labels";
$definitions["Last active"] = "Laatst actief";
$definitions["Last active %s"] = "Laatst actieve %s";
$definitions["Latest News"] = "Laatste nieuws";
$definitions["Loading..."] = "Laden...";
$definitions["Lock"] = "Zet op slot";
$definitions["Log In"] = "Log In";
$definitions["Log Out"] = "Log Uit";

$definitions["Make member and online list visible to:"] = "Maak gebruiker in online-lijst zichtvaar voor:";
$definitions["Manage Groups"] = "Groepen beheren";
$definitions["Manage Languages"] = "Talen beheren";
$definitions["Manage your forum's channels (categories)"] = "Beheer de kanalen van je forum (categorieën)";
$definitions["Mark as read"] = "Markeer als gelezen";
$definitions["Mark all as read"] = "Markeer alle als gelezen";
$definitions["Mark listed as read"] = "Markeer de lijst als gelezen";
$definitions["Maximum size of %s. %s."] = "Maximale groote van %s. %s.";
$definitions["Member groups"] = "Gebruikersgroepen";
$definitions["Member list"] = "Gebruikerslijst";
$definitions["Member List"] = "Gebruikerslijst";
$definitions["Member privacy"] = "Gebruikersprivacy";
$definitions["Members Allowed to View this Conversation"] = "Gebruikers Toegestaan deze Conversatie te Zien";
$definitions["Members Online"] = "Gebruikers online";
$definitions["Members"] = "Gebruikers";
$definitions["Mobile skin"] = "Mobiel jasje";
$definitions["Moderate"] = "Middelmatig";
$definitions["<strong>Move</strong> conversations to the following channel:"] = "<strong>Verplaats</strong> conversaties naar het volgende kanaal:";
$definitions["Mute conversation"] = "Zet conversatie op stil";
$definitions["MySQL database"] = "MySQL database";
$definitions["MySQL host address"] = "MySQL hostadres";
...
$definitions["%s new"] = "%s nieuwe";
$definitions["New conversation"] = "Nieuwe conversatie";
$definitions["New Conversation"] = "Nieuwe Conversatie";
$definitions["New conversations in the past week"] = "Nieuwe conversaties in de afgelopen week";
$definitions["New email"] = "Nieuwe e-mail";
$definitions["New members in the past week"] = "Nieuwe gebruikers in de afgelopen week";
...
$definitions["Order By:"] = "Sorteer per:";
...
$definitions["Post a Reply"] = "Beantwoord";
$definitions["Post count"] = "Aantal berichten";
$definitions["Posts"] = "Berichten";
...
$definitions["Recover Password"] = "Haal Wachtwoord Terug";
$definitions["Registered members"] = "Geregistreerde gebruikers";
$definitions["Registration"] = "Registratie";
$definitions["Remove avatar"] = "Verwijder avatar";
$definitions["Rename Member"] = "Verander Naam van Gebruiker";
$definitions["Reply"] = "Antwoord";
$definitions["Report a bug"] = "Rapporteer een bug";
$definitions["Require users to confirm their email address"] = "Verplicht gebruikers om hun e-mailadres te verifiëren";
$definitions["Restore"] = "Herstel";
$definitions["restore"] = "herstel";
$definitions["Reset"] = "Reset";

$definitions["Save Changes"] = "Sla Wijzigingen Op";
$definitions["Save Draft"] = "Sla Concept Op";
$definitions["Search conversations..."] = "Zoek in conversaties...";
$definitions["Search within this conversation..."] = "Zoek binnen deze conversatie...";
$definitions["Search"] = "Zoek";
$definitions["See the private conversations I've had with %s"] = "Bekijk de privéconversaties die ik heb gehad met %s";
$definitions["Set a New Password"] = "Stel een Nieuw Wachtwoord in";
$definitions["Settings"] = "Instellingen";
$definitions["Show an image in the header"] = "Toon een afbeelding in deze kop";
$definitions["Show matching posts"] = "Laat bijbehorende berichten zien";
$definitions["Show the channel list by default"] = "Laat standaard de kanalenlijst zien";
$definitions["Show the conversation list by default"] = "Laat standaard de conversatielijst zien";
$definitions["Show the forum title in the header"] = "Laat de forumtitel zien in de kop";
$definitions["Sign Up"] = "Registreren";
$definitions["Skins"] = "Skins";
$definitions["Specify Setup Information"] = "Specificeer Instellingsinformatie";
$definitions["Star to receive notifications"] = "Volg om notificaties te ontvangen";
$definitions["Starred"] = "Volgend";
$definitions["Start"] = "Start";
$definitions["Start a conversation"] = "Start een conversatie";
$definitions["Start a new conversation"] = "Start een nieuwe conversatie";
$definitions["Start a private conversation with %s"] = "Start een privéconversatie met %s";
$definitions["Start Conversation"] = "Start de Conversatie";
$definitions["Starting a conversation"] = "Conversatie aan het starten";
$definitions["Statistics"] = "Statistieken";
$definitions["statistic.conversation.plural"] = "%s conversaties";
$definitions["statistic.conversation"] = "%s conversatie";
$definitions["statistic.member.plural"] = "%s gebruikers";
$definitions["statistic.member"] = "%s gebruiker";
